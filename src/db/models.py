...
class BannedWord(models.Model):
    ...
    exact_match_action = models.CharField(max_length=50, default='delete', choices=MESSAGE_MATCH_ACTIONS)
    partial_match_action = models.CharField(max_length=50, default='ignore', choices=MESSAGE_MATCH_ACTIONS)
